...
public class Information extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textname = (TextView) header.findViewById(R.id.name_nav_head);
        textmail = (TextView) header.findViewById(R.id.email_nav_head);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            mAuth.signOut();
            Intent i=new Intent(Information.this,LoginActivity.class);
            startActivity(i);
